...
type OrderServiceClient interface {
	// CreateOrder creates a new order based on the provided NewOrder message
	CreateOrder(ctx context.Context, in *NewOrder, opts ...grpc.CallOption) (*Order, error)
	// ListOrders retrieves a list of all existing orders
	ListOrders(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*OrderList, error)
}
...
func (c *orderServiceClient) ListOrders(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*OrderList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OrderList)
...
type OrderServiceServer interface {
	...
	// ListOrders retrieves a list of all existing orders
	ListOrders(context.Context, *emptypb.Empty) (*OrderList, error)
...
func (UnimplementedOrderServiceServer) ListOrders(context.Context, *emptypb.Empty) (*OrderList, error) {
